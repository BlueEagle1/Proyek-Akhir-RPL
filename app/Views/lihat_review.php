    ...
    <div class="container body">
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <hr>
                <form action="http://localhost:8080/review/daftar_review" method="post">
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align">Nama Pelanggan</label>
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" name="nama_pelanggan" class="form-control" size="4" value="<?php echo $review['nama_pelanggan']; ?>" readonly>
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align">Komen Pelanggan</label>
                        <div class="col-md-6 col-sm-6">
                            <textarea name="komen_pelanggan" class="form-control" readonly><?php echo $review['komen_pelanggan']; ?></textarea>
                        </div>
                    </div>
                    <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                            <input type="submit" name="submit" class="btn btn-primary" value="Kembali ke Daftar Review">
                        </div>
                </form>
            </div>
        </div>
