                            ...
                            <tbody>
                                ...
                                foreach ($review as $key => $data) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo '<a href="http://localhost:8080/review/lihat_review/'.$data['nama_pelanggan'].'" class="btn btn-success btn-sm">Lihat</a>';
                                            echo '<a href="http://localhost:8080/review/hapus_review/'.$data['nama_pelanggan'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Hapus</a>';
                                            ?>
                                        </td>
                                    <?php } ?>
                            <tbody>
