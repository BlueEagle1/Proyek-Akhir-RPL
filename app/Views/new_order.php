...
<body>
	...
	<section class="about">
        ...
        <h3>PESAN LAYANAN SEPATU</h3>
            <form action="http://localhost/proyek_rpl_baru/public/order/new_order/checkout" class="formulir" method="get">
                ...
                <div class="pembungkus-tombol">
                    ...
                    <input accept =".jpeg,.png,.tiff" id="berkas-yang-diunggah" multiple 
                    name="berkas-yang-diunggah" required type="file" />
                </div>
