    ...
    <div class="container body">
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <hr>
                <form action="http://localhost:8080/promo/proses_sunting_promo/<?php echo $promo['kode_promo'];?>" method="post">
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align">Kode Promo</label>
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" name="kode_promo" class="form-control" size="4" value="<?php echo $promo['kode_promo']; ?>" readonly>
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select name="id_layanan" class="form-control" required>
                                ...
                                foreach ($layanan as $key => $data) {
                                    ...
                                    if($promo['id_layanan'] == $data['id_layanan']){ echo 'selected>'; }
                                    else{echo '>';}
                                    echo $data['id_layanan']." - ".$data['nama_layanan']."</option>";
                                }
                                echo "</select>"
                                ?>
                        </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <select name="opsi_pengurangan" class="form-control" required>
                                <option value="Angka Langsung" <?php if($promo['opsi_pengurangan'] == 'Angka Langsung'){ echo 'selected'; } ?>>Angka Langsung</option>
                                <option value="Berdasarkan Persentase" <?php if($promo['opsi_pengurangan'] == 'Berdasarkan Persentase'){ echo 'selected'; } ?>>Berdasarkan Persentase</option>
                            </select>
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" name="pengurangan" class="form-control" value="<?php echo $promo['pengurangan']; ?>" required>
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align">Judul Artikel</label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" name="judul_artikel" class="form-control" value="<?php echo $promo['judul_artikel']; ?>">
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align">Isi Artikel</label>
                        <div class="col-md-6 col-sm-6">
                            <textarea name="isi_artikel" class="form-control"><?php echo $promo['isi_artikel']; ?></textarea>
                        </div>
                    </div>
                    <div class="item form-group">
