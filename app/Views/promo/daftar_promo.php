        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                <div class="container" style="margin-top:20px">
                    <center>
                        <font size="6">Data Promo</font>
                    </center>
                    <hr>
                    <a href="http://localhost:8080/promo/tambah_promo"><button class="btn btn-info">Tambah Data</button></a>
                            ...
                            <tbody>
                                ...
                                foreach ($promo as $key => $data) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $data['opsi_pengurangan'] ?></td>
                                        <td><?php echo $data['pengurangan'] ?></td>
                                        <td>
                                            <?php echo '<a href="http://localhost:8080/promo/sunting_promo/'.$data['kode_promo'].'" class="btn btn-success btn-sm">Sunting</a>';
                                            echo '<a href="http://localhost:8080/promo/hapus_promo/'.$data['kode_promo'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Hapus</a>';
                                            ?>
                                        </td>
                                    <?php } ?>
                            <tbody>
