        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                <div class="container" style="margin-top:20px">
                    ...
                    <hr>
                    <a href="/tambah_layanan"><button class="btn btn-info">Tambah Data</button></a>
                            ...
                            <tbody>
                                ...
                                foreach ($layanan as $key => $data) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo '<a href="index.php?page=edit_mhs&id_layanan='.$data['id_layanan'].'" class="btn btn-success btn-sm">Sunting</a>';
                                            echo '<a href="delete.php?id_layanan='.$data['id_layanan'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Hapus</a>';
                                            ?>
                                        </td>
                                    <?php } ?>
                            <tbody>
