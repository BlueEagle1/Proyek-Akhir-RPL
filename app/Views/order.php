    ...
    <section class="about">
        <div class="container">
            ...
            <div class="tombol-link">
                <a class="link-putih" href="http://localhost:8080/order/new_order">PESAN LAYANAN SEPATU</a>
            </div>
            <div class="tombol-link">
                <a class="link-putih" href="http://localhost:8080/order/check">CEK PEMESANAN</a>
            </div>
        </div>
    </section>
